...
/**
 * List pages for the CMS sidebar.
 * - Root: full collection list (rules allow list).
 * - Admin/user: pass pageIds — uses get (anonymous list is denied, F03 Step B).
 */
...
/**
 * Resolve custom domain → page. Prefers domainIndex (works for anonymous visitors);
 * falls back to collection query when the caller can list (root / legacy).
 */
