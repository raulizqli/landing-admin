...
Cada plan de pago admite **mensual** o **anual** (`billingInterval`: `month` | `year`). El anual cobra 12 meses con **20% de descuento**.
...
STRIPE_PRICE_STARTER_USD_YEARLY=price_...
STRIPE_PRICE_STARTER_MXN_YEARLY=price_...
STRIPE_PRICE_PRO_USD_YEARLY=price_...
STRIPE_PRICE_PRO_MXN_YEARLY=price_...
STRIPE_PRICE_AGENCY_USD_YEARLY=price_...
STRIPE_PRICE_AGENCY_MXN_YEARLY=price_...
# Fallback si falta el precio mensual por moneda:
