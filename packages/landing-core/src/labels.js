...
export const LABEL_CATALOGS = {
  es: {
    ...
    'contact.formContact': 'Email o WhatsApp',
    'contact.formMessage': 'Mensaje',
    'contact.formSubmit': 'Enviar cotización',
    'contact.formSuccess': 'Abrimos WhatsApp con tu mensaje. También guardamos tu consulta.',
    'contact.formError': 'No se pudo enviar. Revisa los campos e inténtalo de nuevo.',
    'contact.formProjectTypePlaceholder': 'Selecciona una opción',
    ...
    'video.carouselAria': 'Carrusel de videos',
    'video.carouselPrevious': 'Anterior',
    'video.carouselNext': 'Siguiente',
    'video.slideGoTo': 'Ir al video {n}',
    ...
    'expedition.pageTitle': 'Documentos de expedición',
    'expedition.footerLink': 'Documentos de expedición',
    'expedition.openFull': 'Abrir a tamaño real',
    'expedition.download': 'Descargar',
    'expedition.close': 'Cerrar',
    'expedition.backToSite': 'Volver al sitio',
    'expedition.backToList': 'Ver todos los documentos',
    'expedition.empty': 'No hay documentos de expedición publicados.',
    'expedition.notFound': 'No se encontró este documento.',
    'expedition.imageAlt': 'Documento de expedición',
    'expedition.documentType': 'Tipo de documento',
    'expedition.folio': 'Folio',
    'expedition.issuedAt': 'Fecha de emisión',
    'expedition.issuer': 'Profesional que lo emite',
    'expedition.licenseNumber': 'Cédula profesional',
  ...
  en: {
    ...
    'contact.formContact': 'Email or WhatsApp',
    'contact.formMessage': 'Message',
    'contact.formSubmit': 'Request a quote',
    'contact.formSuccess': 'We opened WhatsApp with your message. Your inquiry was also saved.',
    'contact.formError': 'Could not send. Check the fields and try again.',
    'contact.formProjectTypePlaceholder': 'Select an option',
    ...
    'video.carouselAria': 'Video carousel',
    'video.carouselPrevious': 'Previous',
    'video.carouselNext': 'Next',
    'video.slideGoTo': 'Go to video {n}',
    ...
    'footer.poweredBy': 'Powered by',
    'expedition.pageTitle': 'Issuance documents',
    'expedition.footerLink': 'Issuance documents',
    'expedition.openFull': 'Open full size',
    'expedition.download': 'Download',
    'expedition.close': 'Close',
    'expedition.backToSite': 'Back to site',
    'expedition.backToList': 'View all documents',
    'expedition.empty': 'There are no published issuance documents.',
    'expedition.notFound': 'This document was not found.',
    'expedition.imageAlt': 'Issuance document',
    'expedition.documentType': 'Document type',
    'expedition.folio': 'Folio',
    'expedition.issuedAt': 'Issue date',
    'expedition.issuer': 'Issuing professional',
    'expedition.licenseNumber': 'Professional license',
...
export const LABEL_GROUPS = [
  ...
  {
    id: 'video',
    title: { es: 'Etiquetas de video', en: 'Video labels' },
    keys: [
      'video.carouselAria',
      'video.carouselPrevious',
      'video.carouselNext',
      'video.slideGoTo',
    ],
  },
  ...
  },
  {
    ...
    keys: [
      ...
      'contact.mapTitle',
      'contact.formName',
      'contact.formProjectType',
      'contact.formContact',
      'contact.formMessage',
      'contact.formSubmit',
      'contact.formSuccess',
      'contact.formError',
      'contact.formProjectTypePlaceholder',
    ],
  },
  {
    id: 'social',
  ...
  },
  {
    ...
    keys: ['footer.rightsReserved', 'footer.legalClose', 'footer.poweredBy', 'expedition.footerLink', 'expedition.pageTitle', 'expedition.openFull', 'expedition.download', 'expedition.close', 'expedition.backToSite', 'expedition.backToList', 'expedition.documentType', 'expedition.folio', 'expedition.issuedAt', 'expedition.issuer', 'expedition.licenseNumber'],
  },
];
...
export const LABEL_ADMIN_NAMES = {
  es: {
    ...
    'contact.formName': 'Formulario: nombre',
    'contact.formProjectType': 'Formulario: tipo de proyecto',
    'contact.formContact': 'Formulario: email o WhatsApp',
    'contact.formMessage': 'Formulario: mensaje',
    'contact.formSubmit': 'Formulario: enviar',
    'contact.formSuccess': 'Formulario: éxito',
    'contact.formError': 'Formulario: error',
    'contact.formProjectTypePlaceholder': 'Formulario: placeholder tipo',
    ...
    'video.carouselAria': 'Aria carrusel de videos',
    'video.carouselPrevious': 'Botón anterior (carrusel de videos)',
    'video.carouselNext': 'Botón siguiente (carrusel de videos)',
    'video.slideGoTo': 'Ir al video ({n})',
    ...
    'footer.poweredBy': 'Powered by',
    'expedition.pageTitle': 'Título de documentos de expedición',
    'expedition.footerLink': 'Enlace del pie (expedición)',
    'expedition.openFull': 'Abrir a tamaño real',
    'expedition.download': 'Descargar documento',
    'expedition.close': 'Cerrar visor',
    'expedition.backToSite': 'Volver al sitio',
    'expedition.backToList': 'Ver todos los documentos',
    'expedition.documentType': 'Tipo de documento',
    'expedition.folio': 'Folio',
  ...
  en: {
    ...
    'contact.formProjectType': 'Form: project type',
    'contact.formContact': 'Form: email or WhatsApp',
    'contact.formMessage': 'Form: message',
    'contact.formSubmit': 'Form: submit',
    'contact.formSuccess': 'Form: success',
    'contact.formError': 'Form: error',
    'contact.formProjectTypePlaceholder': 'Form: project type placeholder',
    ...
    'video.carouselAria': 'Video carousel aria',
    'video.carouselPrevious': 'Previous (video carousel)',
    'video.carouselNext': 'Next (video carousel)',
    'video.slideGoTo': 'Go to video ({n})',
    ...
    'footer.poweredBy': 'Powered by',
    'expedition.pageTitle': 'Issuance documents title',
    'expedition.footerLink': 'Footer link (issuance)',
    'expedition.openFull': 'Open full size',
    'expedition.download': 'Download document',
    'expedition.close': 'Close viewer',
    'expedition.backToSite': 'Back to site',
    'expedition.backToList': 'View all documents',
    'expedition.documentType': 'Document type',
    'expedition.folio': 'Folio',
